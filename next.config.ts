...
const nextConfig: NextConfig = {
  async redirects() {
    ...
    return [
      { source: "/airport-now", destination: "/examples/airport-now", permanent: false },
      { source: "/a", destination: "/examples/airport-now", permanent: false },
      { source: "/a/:iata/:terminal", destination: "/examples/airport-now", permanent: false },
    ];
  },
};
